...
<?php
	...
	$user_email = $_POST['user_email_creation'];
	$password = $_POST['user_password_creation'];
	$sec_question = $_POST['user_security_question'];
	$sec_answer = $_POST['user_security_answer'];
$qry = "INSERT INTO users VALUES ('$user_email','$password','$sec_question','$sec_answer')";
$result=mysql_query($qry);	

if (!$result) {
                        $errmsg_arr[] = 'Account creation failed. Please try another Email ID';
                        $errflag = true;
                        if($errflag) {
...
<font color="#242A56">
<h2>-: <u>Registration Details</u> :-</h2></p>
</div>
<table border="0" style="width:100%;margin-top:25px">
<tr>
<td>
<font color="darkblue">
Welcome</font> <font color="cyan"> <?php echo $_SESSION['SESS_MEMBER_ID']; ?> </font><font color="darkblue">!!! We are almost done.</font><br>
<font color="darkblue">Kindly fill the details below to complete your registration process.</font>
</td>
</tr>
</table>
<hr style="width:100%;margin-top:10px">
<form  id="customer_reg" name ="customer_reg" method="post" action="customer_registration_exec.php" onsubmit="return validateForm();">
